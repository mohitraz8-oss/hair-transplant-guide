// Stores a paid "1:1 Video Call" booking. Only someone holding a valid, paid
// video_call access token can submit — mirrors submit-estimate.js security.
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    if (purchase.status !== 'paid' || purchase.tier !== 'video_call') return res.status(403).json({ error: 'not_eligible' });
